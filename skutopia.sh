...
alias portforward_rdp_emu_prd='CLOUDSDK_PYTHON_SITEPACKAGES=1 gcloud compute ssh --zone "australia-southeast1-b" "jumpbox"  --tunnel-through-iap --project "skutopia-production" -- -NL 19097:"10.11.0.110":3389 -v'
